...
# Rock-Paper-Scissors
colors_rps = [(255, 0, 0), (0, 255, 0), (0, 0, 255)]
rules_rps = Rules()
rules_rps.add(ClassicRule(0, 0, True, {2: [0, 1, 2]}))
rules_rps.add(ClassicRule(0, 2, True, {1: [0, 1, 2]}))
rules_rps.add(ClassicRule(1, 1, True, {0: [0, 1, 2]}))
rules_rps.add(ClassicRule(1, 0, True, {2: [0, 1, 2]}))
rules_rps.add(ClassicRule(2, 2, True, {1: [0, 1, 2]}))
rules_rps.add(ClassicRule(2, 1, True, {0: [0, 1, 2]}))
